...
static const char *dmenu_netrc[]   = { "dmenu_netrc",   NULL                               };
...
static const Key keys[] = {
	...
	{ MODKEY,           XK_equal,      spawn,          {.v = dmenu_netrc } }, // mod         + equal   creates new sketch
...
updatesystray(void)
{
	...
	unsigned int sw = TEXTW(stext) - lrpad + systrayspacing - sp;
	unsigned int w = 1;
